...
class Decoder{
  ...
  private ForthGraphs graph;            // Grafiikka
  private Object temp;
  ...
  protected void listen(String input){
    ...
    // Pinojen n‰ytt‰miseen testimieless‰
      ...
      String[] temp = input.split(" "); // K‰skyjen tokenisointi
  ...
  protected void decode(Stack<Object> cs, Stack<Object> ds,int loop_index){
    ...
    while (!cs.empty()){
      try{
        ...
        // : ja ; merkkien, sek‰ mahd. vahingossa tulleiden tyhjien merkkijonojen poisto
        ...
        // Kysyy k‰ytt‰j‰lt‰ merkkijonoa, voi olla useampi --> datapinoon
          ...
          String[] temp = value.split(" "); // K‰skyjen tokenisointi
          for (int i = 0 ; i < temp.length ; i++){
            if (isInteger(temp[i])){
              ds.push((Integer) Integer.parseInt(temp[i]));
        ...
        //Grafiikkak‰skyt
          ...
          if (vars.size() >= 1){
            ...
            cs.clear();
            throw new IllegalArgumentException("Komentoa " + temp + " ei tunnistettu");
          }
        }
        // Poikkeukset
        ...
        cs.clear();
        ds.clear();
        System.err.println("K‰skyll‰ liian v‰h‰n parametreja:\n" + es );
        break;
      } catch (Exception e){ 
        cs.clear();
        ds.clear();
        System.err.println("Tarkista formaatti.\n" + e);
        break;
      }       
